$(function() {
    ...
    $('.portfolio-filter').on('click', function () {
        ...
        $('.portfolio-filter').removeClass('active').attr('aria-pressed', 'false');
    ...
    /* ----------------------------------------------------------- */
    /*  PORTFOLIO GRID ITEM ANIMATION ON remove the toggle and put la 
    /* ----------------------------------------------------------- */
    ...
    $(".formcontact").on("submit", function() {
        if ($(this).attr("action").indexOf("formsubmit.co") !== -1) {
            return true;
        }
